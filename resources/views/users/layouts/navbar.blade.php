...
<nav class="navbar navbar-expand-lg  blur blur-rounded top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
    <div class="container-fluid px-0 me-4 ps-3">
      <a class="navbar-brand font-weight-bolder ms-sm-3 ps-3 " href="https://demos.creative-tim.com/soft-ui-design-system/index.html" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom" target="_blank">
        Shop-KT
      </a>
...
{{-- 
              ...
              <div class="d-none d-lg-block">
                <ul class="list-group">
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{URL:: to('/')}}">
                      <div class="d-flex">
                        ...
                        <div>
                          <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Tang Chủ</h6>
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{URL:: to('/product_user')}}">
                      <div class="d-flex">
                        <div class="icon h-10 me-3 d-flex mt-1">
                        ...
                        <div>
                          <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Sản Phẩm</h6>
                        </div>
                      </div>
                    </a>
                  </li>
                ...
                <div class="col-md-12 g-0">
                  ...
                  <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{URL::to('/')}}">
                    <div class="d-flex">
                      ...
                      <div>
                        <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Trang Chủ</h6>
          ...
          <li class="nav-item dropdown dropdown-hover mx-2">
            ...
            <ul class="dropdown-menu dropdown-menu-animation dropdown-lg mt-0 mt-lg-3 p-3 border-radius-lg" aria-labelledby="dropdownMenuDocs">
              <div class="d-none d-lg-block">
                <ul class="list-group">
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{URL:: to('/product_jackets')}}">
                      <div class="d-flex">
                        <div class="icon h-10 me-3 d-flex mt-1">
                        </div>
                        <div>
                          <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">ÁO Khoác</h6>
                        </div>
                      </div>
                    </a>
                  </li>
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{URL:: to('/product_tshirts')}}">
                      <div class="d-flex">
                        <div class="icon h-10 me-3 d-flex mt-1">
                        </div>
                        <div>
                          <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Áo Thun</h6>
                        </div>
                      </div>
                    </a>
                  </li>
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{URL::to('/product_trouser')}}">
                      <div class="d-flex">
                        <div class="icon h-10 me-3 d-flex mt-1">
                        </div>
                        <div>
                          <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Quần Dài</h6>
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{URL::to('/product_carpri')}}">
                      <div class="d-flex">
                        <div class="icon h-10 me-3 d-flex mt-1">
                        </div>
                        <div>
                          <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Quần Ngắn</h6>
                        </div>
                      </div>
                    </a>
                  </li>
                ...
                <div class="col-md-12 g-0">
                  ...
                  <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{URL::to('/..')}}">
                    <div class="d-flex">
                      ...
                      <div>
                        <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Túi Sách</h6>
                      </div>
                    </div>
                  </a>
                </div>
          ...
          <li class="nav-item dropdown dropdown-hover mx-2">
            <a href="{{URL:: to('/cart_oder')}}" class="mb-0 me-1 mt-2 mt-md-0">
              <img src="{{ asset('assets_users/img/logo/grocery-store.png')}}" alt="down-arrow" class="arrow ms-1" style="width: 32px">
            </a>
          </li>

          <li class="nav-item dropdown dropdown-hover mx-2">
            <a href="{{URL:: to('/profile')}}" class="btn btn-sm text-white  bg-dark  btn-round mb-0 me-1 mt-2 mt-md-0 ">Profile</a>
          </li>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0 ms-lg-12 ps-lg-5" id="navigation">
      <ul class="navbar-nav navbar-nav-hover w-100">
        ...
        <li class="nav-item my-auto ms-3 ms-lg-0">
          <a href="https://www.creative-tim.com/product/soft-ui-design-system-pro" class="btn btn-sm  btn-dark  btn-round mb-0 me-1 mt-2 mt-md-0">Upgrade to Pro</a>
        </li>
      </ul>
    </div>
  </div>
