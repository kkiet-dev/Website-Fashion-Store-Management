        ...
        <div class="card">
          <div class="card-body p-3">
            <div class="row">
              <div class="col-8">
                <div class="numbers">
                  <p class="text-sm mb-0 text-uppercase font-weight-bold">Today's Money Order</p>
                  ...
                  <a class="text-success text-sm font-weight-bolder" href="{{URL::to('/oder')}}">View Details</a>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-8">
                <div class="numbers">
                  ...
                  <a class="text-success text-sm font-weight-bolder" href="{{URL::to('/users')}}">View Details</a>
                </div>
              </div>
              <div class="col-4 text-end">
                ...
                <div class="numbers">
                  ...
                  <h5 class="font-weight-bolder text-success">
                    @if($recentUsersCount > 0)
                       +{{$recentUsersCount}}
                    @else
                    <h5 class="font-weight-bolde text-black">
                      0
                    </h5> 
                    @endif
                  </h5>
