        ...
        <div class="col-12">
          <div class="card mb-4">
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                   ...
                   {{-- user name --}}
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0 text-wrap">{{ $article->description}}</p>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">{{ $article->created_at}}</span>
                      </td>
                      <td class="align-middle text-center">
                      ...
                      <td class="align-middle">
                          <a href="{{ route('article.edit', $article->id) }}" class="btn btn-warning text-secondary font-weight-bold text-xs">
                              Edit
                          </a>
                          <a>
                            <form method="POST" action="{{ route('article.delete', $article->id) }}" style="display: inline-block;">
                              @csrf
                              @method('DELETE')
            ...
            <div class="p-4">
                ...
                <a type="button" href="{{ route('article.create') }}" class="btn btn-primary text-white font-weight-bold text-xs">
                   Add
                 </a>
              </div>
          </div>
